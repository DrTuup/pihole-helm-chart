...
| config.debug | object | `{"aliasclients":false,"all":false,"api":false,"arp":false,"caps":false,"clients":false,"config":false,"database":false,"dnssec":false,"edns0":false,"events":false,"extra":false,"flags":false,"gc":false,"helper":false,"inotify":false,"locks":false,"netlink":false,"networking":false,"ntp":false,"overtime":false,"queries":false,"regex":false,"reserved":false,"resolver":false,"shmem":false,"status":false,"timing":false,"tls":false,"vectors":false,"webserver":false}` | Debug logging configuration (normally all disabled) |
...
| config.debug.reserved | bool | `false` | Debug reserved for future use |
